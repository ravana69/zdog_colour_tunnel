...
var size = w > h ? w : h;
document.querySelector('.render').width = size;
document.querySelector('.render').height = size;
document.querySelector('.render').style.left = (w / 2 - size / 2) + "px";
document.querySelector('.render').style.top = (h / 2 - size / 2) + "px";
document.querySelector('.render').style.width = size+ "px";
document.querySelector('.render').style.height = size + "px";
...
function render () {
	...
	var dest = document.querySelector('.render').getContext('2d');
	var w = window.innerWidth;
	var h = window.innerHeight;
	var size = w > h ? w : h;
	dest.drawImage(document.querySelector('.zdog-canvas'), 0, 0,800,800,0,0,size,size);
